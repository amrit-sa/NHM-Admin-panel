        ...
        <div className='container-fluid'>
            ...
            <header>
                <div className='d-flex justify-content-between '>
                    <span className='fs-5 px-2 font-primary'>{t('ghatak')}</span>
            ...
            <div className='py-0 sub-wrapper'>
                <GhatakTable data={allghataks} editGhatak={editGhatak} handleShow={handleShow}/>
            </div>
            {/* <ProjectModal 
                    editdata={editdata} 
                    editmode={editmode} 
...
export default connect(mapStateToProps, null)(Ghataks)